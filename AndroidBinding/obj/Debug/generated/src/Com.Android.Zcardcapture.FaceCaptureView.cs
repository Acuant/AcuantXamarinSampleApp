...
namespace Com.Android.Zcardcapture {
	...
	public sealed partial class FaceCaptureView : global::Android.Views.View {
		...
		static IntPtr id_a;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.zcardcapture']/class[@name='FaceCaptureView']/method[@name='a' and count(parameter)=0]"
		[Register ("a", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.zcardcapture']/class[@name='FaceCaptureView']/method[@name='a' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("a", "(Landroid/content/Context;)Z", "")]
		public static unsafe bool A (global::Android.Content.Context context)
		{
