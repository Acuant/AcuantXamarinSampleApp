...
namespace Com.Acuant.Mobilesdk.Exceptions {
	...
	public partial class AuthorizationException : global::Java.Lang.Exception {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.acuant.mobilesdk.exceptions']/class[@name='AuthorizationException']/constructor[@name='AuthorizationException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe AuthorizationException (string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (AuthorizationException)) {
					SetHandle (
