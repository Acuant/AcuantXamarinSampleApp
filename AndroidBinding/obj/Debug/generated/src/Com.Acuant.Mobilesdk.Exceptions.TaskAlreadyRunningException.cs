...
namespace Com.Acuant.Mobilesdk.Exceptions {
	...
	public partial class TaskAlreadyRunningException : global::Java.Lang.RuntimeException {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.acuant.mobilesdk.exceptions']/class[@name='TaskAlreadyRunningException']/constructor[@name='TaskAlreadyRunningException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe TaskAlreadyRunningException (string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (TaskAlreadyRunningException)) {
					SetHandle (
