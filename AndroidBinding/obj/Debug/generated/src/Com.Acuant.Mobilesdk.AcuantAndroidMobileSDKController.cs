...
#pragma warning restore 0169
		...
		static Delegate cb_getShowFacialTimeoutErrorDialog;
#pragma warning disable 0169
		static Delegate GetGetShowFacialTimeoutErrorDialogHandler ()
		{
			if (cb_getShowFacialTimeoutErrorDialog == null)
				cb_getShowFacialTimeoutErrorDialog = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_GetShowFacialTimeoutErrorDialog);
			return cb_getShowFacialTimeoutErrorDialog;
		}

		static bool n_GetShowFacialTimeoutErrorDialog (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController __this = global::Java.Lang.Object.GetObject<global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.ShowFacialTimeoutErrorDialog;
		}
#pragma warning restore 0169

		static Delegate cb_setShowFacialTimeoutErrorDialog_Z;
#pragma warning disable 0169
		static Delegate GetSetShowFacialTimeoutErrorDialog_ZHandler ()
		{
			if (cb_setShowFacialTimeoutErrorDialog_Z == null)
				cb_setShowFacialTimeoutErrorDialog_Z = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, bool>) n_SetShowFacialTimeoutErrorDialog_Z);
			return cb_setShowFacialTimeoutErrorDialog_Z;
		}

		static void n_SetShowFacialTimeoutErrorDialog_Z (IntPtr jnienv, IntPtr native__this, bool flag)
		{
			global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController __this = global::Java.Lang.Object.GetObject<global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.ShowFacialTimeoutErrorDialog = flag;
		}
#pragma warning restore 0169

		static IntPtr id_getShowFacialTimeoutErrorDialog;
		static IntPtr id_setShowFacialTimeoutErrorDialog_Z;
		public virtual unsafe bool ShowFacialTimeoutErrorDialog {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk']/class[@name='AcuantAndroidMobileSDKController']/method[@name='getShowFacialTimeoutErrorDialog' and count(parameter)=0]"
			[Register ("getShowFacialTimeoutErrorDialog", "()Z", "GetGetShowFacialTimeoutErrorDialogHandler")]
			get {
				if (id_getShowFacialTimeoutErrorDialog == IntPtr.Zero)
					id_getShowFacialTimeoutErrorDialog = JNIEnv.GetMethodID (class_ref, "getShowFacialTimeoutErrorDialog", "()Z");
				try {

					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_getShowFacialTimeoutErrorDialog);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getShowFacialTimeoutErrorDialog", "()Z"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk']/class[@name='AcuantAndroidMobileSDKController']/method[@name='setShowFacialTimeoutErrorDialog' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("setShowFacialTimeoutErrorDialog", "(Z)V", "GetSetShowFacialTimeoutErrorDialog_ZHandler")]
			set {
				if (id_setShowFacialTimeoutErrorDialog_Z == IntPtr.Zero)
					id_setShowFacialTimeoutErrorDialog_Z = JNIEnv.GetMethodID (class_ref, "setShowFacialTimeoutErrorDialog", "(Z)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setShowFacialTimeoutErrorDialog_Z, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setShowFacialTimeoutErrorDialog", "(Z)V"), __args);
				} finally {
				}
			}
		}
