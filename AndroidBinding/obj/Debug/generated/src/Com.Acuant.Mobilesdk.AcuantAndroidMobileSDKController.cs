...
#pragma warning restore 0169
		...
		static Delegate cb_callActivateLicenseKeyService_Ljava_lang_String_;
#pragma warning disable 0169
		static Delegate GetCallActivateLicenseKeyService_Ljava_lang_String_Handler ()
		{
			if (cb_callActivateLicenseKeyService_Ljava_lang_String_ == null)
				cb_callActivateLicenseKeyService_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_CallActivateLicenseKeyService_Ljava_lang_String_);
			return cb_callActivateLicenseKeyService_Ljava_lang_String_;
		}

		static void n_CallActivateLicenseKeyService_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_licenseKey)
		{
			global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController __this = global::Java.Lang.Object.GetObject<global::Com.Acuant.Mobilesdk.AcuantAndroidMobileSDKController> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string licenseKey = JNIEnv.GetString (native_licenseKey, JniHandleOwnership.DoNotTransfer);
			__this.CallActivateLicenseKeyService (licenseKey);
		}
#pragma warning restore 0169

		static IntPtr id_callActivateLicenseKeyService_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk']/class[@name='AcuantAndroidMobileSDKController']/method[@name='callActivateLicenseKeyService' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("callActivateLicenseKeyService", "(Ljava/lang/String;)V", "GetCallActivateLicenseKeyService_Ljava_lang_String_Handler")]
		public virtual unsafe void CallActivateLicenseKeyService (string licenseKey)
		{
			if (id_callActivateLicenseKeyService_Ljava_lang_String_ == IntPtr.Zero)
				id_callActivateLicenseKeyService_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "callActivateLicenseKeyService", "(Ljava/lang/String;)V");
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_callActivateLicenseKeyService_Ljava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "callActivateLicenseKeyService", "(Ljava/lang/String;)V"), __args);
			} finally {
...
#region "Event implementation for Com.Acuant.Mobilesdk.IWebServiceListener"
		public event EventHandler<global::Com.Acuant.Mobilesdk.ActivateLicenseKeyCompletedEventArgs> ActivateLicenseKeyCompleted {
			add {
				global::Java.Interop.EventHelper.AddEventHandler<global::Com.Acuant.Mobilesdk.IWebServiceListener, global::Com.Acuant.Mobilesdk.IWebServiceListenerImplementor>(
						...
						__h => __h.ActivateLicenseKeyCompletedHandler += value);
			}
			remove {
