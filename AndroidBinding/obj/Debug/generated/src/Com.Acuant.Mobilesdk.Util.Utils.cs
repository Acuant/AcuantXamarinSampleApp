...
namespace Com.Acuant.Mobilesdk.Util {
	...
	public partial class Utils : global::Java.Lang.Object {
		...
		static IntPtr id_getFreeMemorySize;
		public static unsafe long FreeMemorySize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='Utils']/method[@name='getFreeMemorySize' and count(parameter)=0]"
			[Register ("getFreeMemorySize", "()J", "GetGetFreeMemorySizeHandler")]
			get {
				if (id_getFreeMemorySize == IntPtr.Zero)
					id_getFreeMemorySize = JNIEnv.GetStaticMethodID (class_ref, "getFreeMemorySize", "()J");
				try {
					return JNIEnv.CallStaticLongMethod  (class_ref, id_getFreeMemorySize);
				} finally {
				}
			}
		}

		static IntPtr id_isElephoneModel;
		public static unsafe bool IsElephoneModel {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='Utils']/method[@name='isElephoneModel' and count(parameter)=0]"
			[Register ("isElephoneModel", "()Z", "GetIsElephoneModelHandler")]
			get {
				if (id_isElephoneModel == IntPtr.Zero)
					id_isElephoneModel = JNIEnv.GetStaticMethodID (class_ref, "isElephoneModel", "()Z");
				try {
					return JNIEnv.CallStaticBooleanMethod  (class_ref, id_isElephoneModel);
				} finally {
				}
			}
		}
		...
		static IntPtr id_getUsedMemorySize;
		public static unsafe long UsedMemorySize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='Utils']/method[@name='getUsedMemorySize' and count(parameter)=0]"
			[Register ("getUsedMemorySize", "()J", "GetGetUsedMemorySizeHandler")]
			get {
				if (id_getUsedMemorySize == IntPtr.Zero)
					id_getUsedMemorySize = JNIEnv.GetStaticMethodID (class_ref, "getUsedMemorySize", "()J");
				try {
					return JNIEnv.CallStaticLongMethod  (class_ref, id_getUsedMemorySize);
				} finally {
				}
			}
		}
		...
		static IntPtr id_getAvailableMemoryInfo_Landroid_app_Activity_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='Utils']/method[@name='getAvailableMemoryInfo' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
		[Register ("getAvailableMemoryInfo", "(Landroid/app/Activity;)Landroid/app/ActivityManager$MemoryInfo;", "")]
		public static unsafe global::Android.App.ActivityManager.MemoryInfo GetAvailableMemoryInfo (global::Android.App.Activity act)
		{
			if (id_getAvailableMemoryInfo_Landroid_app_Activity_ == IntPtr.Zero)
				id_getAvailableMemoryInfo_Landroid_app_Activity_ = JNIEnv.GetStaticMethodID (class_ref, "getAvailableMemoryInfo", "(Landroid/app/Activity;)Landroid/app/ActivityManager$MemoryInfo;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (act);
				global::Android.App.ActivityManager.MemoryInfo __ret = global::Java.Lang.Object.GetObject<global::Android.App.ActivityManager.MemoryInfo> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getAvailableMemoryInfo_Landroid_app_Activity_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
