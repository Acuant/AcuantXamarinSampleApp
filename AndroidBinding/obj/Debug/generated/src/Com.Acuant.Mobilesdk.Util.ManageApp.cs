...
namespace Com.Acuant.Mobilesdk.Util {
	...
	public partial class ManageApp : global::Android.App.Application {
		...
		public static unsafe global::Com.Acuant.Mobilesdk.Util.ManageApp Instance {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='getInstance' and count(parameter)=0]"
			[Register ("getInstance", "()Lcom/acuant/mobilesdk/util/ManageApp;", "GetGetInstanceHandler")]
			get {
				if (id_getInstance == IntPtr.Zero)
					id_getInstance = JNIEnv.GetStaticMethodID (class_ref, "getInstance", "()Lcom/acuant/mobilesdk/util/ManageApp;");
				try {
					return global::Java.Lang.Object.GetObject<global::Com.Acuant.Mobilesdk.Util.ManageApp> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getInstance), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}

		static Delegate cb_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_;
#pragma warning disable 0169
		static Delegate GetJsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_Handler ()
		{
			if (cb_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_ == null)
				cb_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_JsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_);
			return cb_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_;
		}

		static IntPtr n_JsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_json, IntPtr native_sKey)
		{
...
#pragma warning restore 0169
		...
		static IntPtr id_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='jsonarrayTobyte' and count(parameter)=2 and parameter[1][@type='org.json.JSONObject'] and parameter[2][@type='java.lang.String']]"
		[Register ("jsonarrayTobyte", "(Lorg/json/JSONObject;Ljava/lang/String;)[B", "GetJsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_Handler")]
		public virtual unsafe byte[] JsonarrayTobyte (global::Org.Json.JSONObject json, string sKey)
		{
			if (id_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_ == IntPtr.Zero)
				id_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "jsonarrayTobyte", "(Lorg/json/JSONObject;Ljava/lang/String;)[B");
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_jsonarrayTobyte_Lorg_json_JSONObject_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef, typeof (byte));
				else
					__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "jsonarrayTobyte", "(Lorg/json/JSONObject;Ljava/lang/String;)[B"), __args), JniHandleOwnership.TransferLocalRef, typeof (byte));
				return __ret;
			} finally {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='loadBoolean' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='loadInt' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='loadStrings' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='storeBoolean' and count(parameter)=2 and parameter[1][@type='boolean'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='storeInt' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/class[@name='ManageApp']/method[@name='storeStrings' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
