...
namespace Com.Acuant.Mobilesdk {
	...
	public partial class ProcessImageRequestOptions : global::Java.Lang.Object {
		...
		static IntPtr imageSource_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.acuant.mobilesdk']/class[@name='ProcessImageRequestOptions']/field[@name='imageSource']"
		[Register ("imageSource")]
		public int ImageSource {
			get {
				if (imageSource_jfieldId == IntPtr.Zero)
					imageSource_jfieldId = JNIEnv.GetFieldID (class_ref, "imageSource", "I");
				return JNIEnv.GetIntField (((global::Java.Lang.Object) this).Handle, imageSource_jfieldId);
			}
			set {
				if (imageSource_jfieldId == IntPtr.Zero)
					imageSource_jfieldId = JNIEnv.GetFieldID (class_ref, "imageSource", "I");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, imageSource_jfieldId, value);
				} finally {
				}
			}
		}
