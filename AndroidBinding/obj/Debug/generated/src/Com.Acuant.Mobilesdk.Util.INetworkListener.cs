...
namespace Com.Acuant.Mobilesdk.Util {
	...
	public partial interface INetworkListener : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.util']/interface[@name='NetworkListener']/method[@name='a' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
		[Register ("a", "(Ljava/lang/String;I)V", "GetA_Ljava_lang_String_IHandler:Com.Acuant.Mobilesdk.Util.INetworkListenerInvoker, AndroidBinding")]
		void A (string p0, int p1);
...
#pragma warning disable 0169
		static Delegate GetA_Ljava_lang_String_IHandler ()
		{
			if (cb_a_Ljava_lang_String_I == null)
				cb_a_Ljava_lang_String_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, int>) n_A_Ljava_lang_String_I);
			return cb_a_Ljava_lang_String_I;
		}

		static void n_A_Ljava_lang_String_I (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, int p1)
		{
...
#pragma warning restore 0169
		...
		IntPtr id_a_Ljava_lang_String_I;
