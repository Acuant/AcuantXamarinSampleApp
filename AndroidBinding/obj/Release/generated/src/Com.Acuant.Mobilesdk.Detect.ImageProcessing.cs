...
namespace Com.Acuant.Mobilesdk.Detect {
	...
	public partial class ImageProcessing : global::Java.Lang.Object {
		...
		static IntPtr id_freeMemory;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.acuant.mobilesdk.detect']/class[@name='ImageProcessing']/method[@name='freeMemory' and count(parameter)=0]"
		[Register ("freeMemory", "()V", "")]
		public static unsafe void FreeMemory ()
		{
			if (id_freeMemory == IntPtr.Zero)
				id_freeMemory = JNIEnv.GetStaticMethodID (class_ref, "freeMemory", "()V");
			try {
				JNIEnv.CallStaticVoidMethod  (class_ref, id_freeMemory);
			} finally {
			}
		}
