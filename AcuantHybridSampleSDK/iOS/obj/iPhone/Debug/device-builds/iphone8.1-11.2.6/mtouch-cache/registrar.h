...
@protocol AcuantFacialCaptureDelegate
	@required @property (nonatomic, assign, readonly) BOOL shouldShowFacialTimeoutAlert;
...
@protocol AcuantMobileSDKControllerCapturingDelegate
	...
	@required -(void) didCaptureCropImage:(UIImage *)p0 scanBackSide:(BOOL)p1 andCardType:(unsigned int)p2 withImageMetrics:(NSDictionary *)p3;
	@required -(void) didCaptureData:(NSString *)p0;
	@required -(void) didFailWithError:(id)p0;
	@optional -(void) didCaptureCropImage:(UIImage *)p0 andData:(NSString *)p1 scanBackSide:(BOOL)p2 withImageMetrics:(NSDictionary *)p3;
	@optional -(void) didFailToCaptureCropImage;
	@optional -(void) didCaptureOriginalImage:(UIImage *)p0;
	@optional -(void) barcodeScanTimeOut:(UIImage *)p0 withImageMetrics:(NSDictionary *)p1 andOriginalImage:(UIImage *)p2;
	@optional -(void) didCancelToCaptureData:(UIImage *)p0 withImageMetrics:(NSDictionary *)p1 andOriginalImage:(UIImage *)p2;
