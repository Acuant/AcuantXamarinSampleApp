package md58597ba74c49f8836135b4dce8591ff45;


public class AppStateLifecyle
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.DeviceInfo.AppStateLifecyle, Plugin.DeviceInfo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AppStateLifecyle.class, __md_methods);
	}


	public AppStateLifecyle () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AppStateLifecyle.class)
			mono.android.TypeManager.Activate ("Plugin.DeviceInfo.AppStateLifecyle, Plugin.DeviceInfo, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
