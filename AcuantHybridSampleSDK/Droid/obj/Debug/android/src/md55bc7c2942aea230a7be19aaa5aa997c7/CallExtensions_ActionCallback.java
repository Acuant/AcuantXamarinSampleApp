package md55bc7c2942aea230a7be19aaa5aa997c7;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Square.OkHttp3.CallExtensions+ActionCallback, Square.OkHttp3, Version=3.5.0.0, Culture=neutral, PublicKeyToken=null", CallExtensions_ActionCallback.class, __md_methods);
	}


	public CallExtensions_ActionCallback () throws java.lang.Throwable
	{
		super ();
		if (getClass () == CallExtensions_ActionCallback.class)
			mono.android.TypeManager.Activate ("Square.OkHttp3.CallExtensions+ActionCallback, Square.OkHttp3, Version=3.5.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
