...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Square.OkHttp3.OkHttpClient+Builder+AuthenticatorImpl, Square.OkHttp3, Version=3.5.0.0, Culture=neutral, PublicKeyToken=null", OkHttpClient$Builder_AuthenticatorImpl.class, __md_methods);
	}


	public OkHttpClient$Builder_AuthenticatorImpl () throws java.lang.Throwable
	{
		super ();
		if (getClass () == OkHttpClient$Builder_AuthenticatorImpl.class)
			mono.android.TypeManager.Activate ("Square.OkHttp3.OkHttpClient+Builder+AuthenticatorImpl, Square.OkHttp3, Version=3.5.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
