...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onCroppingBarcodeSideFinished:(Landroid/graphics/Bitmap;)V:GetOnCroppingBarcodeSideFinished_Landroid_graphics_Bitmap_Handler:Com.Acuant.Mobilesdk.Detect.PDF417.IBarcodeCroppingListenerInvoker, AndroidBinding\n" +
			"";
	...
	public void onCroppingBarcodeSideFinished (android.graphics.Bitmap p0)
	{
		n_onCroppingBarcodeSideFinished (p0);
	}

	private native void n_onCroppingBarcodeSideFinished (android.graphics.Bitmap p0);
