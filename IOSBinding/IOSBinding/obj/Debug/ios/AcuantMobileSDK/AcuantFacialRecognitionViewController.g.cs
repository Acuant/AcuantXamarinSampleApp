...
namespace AcuantMobileSDK {
	...
	public unsafe partial class AcuantFacialRecognitionViewController : NSObject {
		...
		[CompilerGenerated]
		public static NSObject PresentFacialCaptureInterfaceWithDelegate (NSObject @delegate, NSObject sdkController, NSObject parentVC, bool cancelVisible, CGRect cancelRect, string watermarkText, NSAttributedString message, CGRect rect)
		{
			if (@delegate == null)
			...
			NSObject ret;
			ret = Runtime.GetNSObject (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr_bool_CGRect_IntPtr_IntPtr_CGRect (class_ptr, Selector.GetHandle ("presentFacialCaptureInterfaceWithDelegate:withSDK:inViewController:withCancelButton:withCancelButtonRect:withWaterMark:withBlinkMessage:inRect:"), @delegate.Handle, sdkController.Handle, parentVC.Handle, cancelVisible, cancelRect, nswatermarkText, message.Handle, rect));
