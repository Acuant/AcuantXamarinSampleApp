...
namespace AcuantMobileSDK {
	...
	public unsafe partial class AcuantFacialData : AcuantCardResult {
		...
		[CompilerGenerated]
		public virtual bool IsFacialEnabled {
			[Export ("isFacialEnabled")]
			get {
				if (IsDirectBinding) {
					return global::ApiDefinition.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isFacialEnabled"));
				} else {
					return global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("isFacialEnabled"));
				}
			}
			
			[Export ("setIsFacialEnabled:")]
			set {
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setIsFacialEnabled:"), value);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_bool (this.SuperHandle, Selector.GetHandle ("setIsFacialEnabled:"), value);
				}
			}
		}
