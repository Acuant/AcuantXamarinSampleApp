...
namespace AcuantMobileSDK {
	...
	public unsafe partial class AcuantCardProcessRequestOptions : NSObject {
		...
		public virtual bool logtransaction {
			...
			get {
				if (IsDirectBinding) {
					return global::ApiDefinition.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("logtransaction"));
				} else {
					return global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("logtransaction"));
				}
			}
			
			[Export ("setLogtransaction:")]
			set {
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setLogtransaction:"), value);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_bool (this.SuperHandle, Selector.GetHandle ("setLogtransaction:"), value);
				}
			}
		}
